...
export const projects: Project[] = [
  ...
  },
  {
    id: "succevia-hub",
    title: "Succevia Hub",
    subtitle: "Premium Digital Marketplace",
    ...
    github: "https://github.com/ButtySaylee/succevia-hub",
    liveUrl: "https://succeviahub.vercel.app/",
    featured: true,
    image: "/images/projects/succevia-hub-preview.png"
  },
  {
    id: "data-insights-generator",
    title: "Apnapan Data Insights Pulse",
    subtitle: "Student Well-being Analytics Dashboard",
    ...
    approach: "Developed an automated analytics platform that transforms raw survey data into meaningful insights and visual reports using interactive dashboards, secure data processing, and automated reporting.",
    solution: "Full-stack Streamlit application with Python backend, MongoDB database, advanced data visualizations using Plotly, Google Sheets API integration with OAuth 2.0 authentication for secure real-time data access, and automated PDF report generation.",
    impact: "Processing and visualizing 100+ student survey responses in real-time, enabling faster data-driven decisions for student well-being programs with automated report generation.",
    techStack: ["Python", "Streamlit", "MongoDB", "Plotly", "Pandas", "Google Sheets API", "OAuth 2.0"],
